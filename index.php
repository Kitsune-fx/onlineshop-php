    ...
    <head>
        ...
        <body>
            <div class="container" style="width:100%;height:10%;margin:auto;padding:1em;text-align:right;top:0px;positon:fixed;background-color:#996515;color:white;">   
                <a href="register.php" style="font-size:20px;" class="btn btn-primary">สมัครสมาชิก</a>
     ...
     <div class="container" style="font-size:26px;text-align:center;">
        ...
        <form action="logincheck.php" method="post" style="width:300px;margin:auto;">
            Username:<input type="text" required name="mem_user" class="form-control">
           <br> Password:<input type="password" required name="mem_pwd" class="form-control">
